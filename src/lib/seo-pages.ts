...
export const seoPages: SeoPage[] = [
  ...
  },
  {
    ...
    intro:
      "AwardPing is built for the practical office workflow: maintain a watchlist of public award pages, check them every 90 minutes, and keep a record of detected updates.",
    bullets: [
