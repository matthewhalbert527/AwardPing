export type SourceAiReviewStatus =
  | "unreviewed"
...
export type SourceAiReviewExplanation = {
  status: SourceAiReviewStatus;
  complete: boolean;
  canContributePublicFacts: boolean;
  canBeMonitored: boolean;
  needsAiReview: boolean;
  needsManualReview: boolean;
  reason: string;
  awardRelevance: string | null;
  cycleRelevance: string | null;
  confidence: string | null;
  qualityFlags: string[];
  rejectionReason: string | null;
  hasBaselineFacts: boolean;
  hasBaselineFactsRejected: boolean;
...
export function sourceHasClearAiDetermination(source: SourceAiReviewSource | null | undefined) {
  return explainSourceAiReviewStatus(source).complete;
}

export function sourceNeedsAiReview(source: SourceAiReviewSource | null | undefined) {
  return explainSourceAiReviewStatus(source).needsAiReview;
}

export function sourceNeedsManualReview(source: SourceAiReviewSource | null | undefined) {
  return explainSourceAiReviewStatus(source).needsManualReview;
}

export function sourceCanContributePublicFacts(source: SourceAiReviewSource | null | undefined) {
  return explainSourceAiReviewStatus(source).canContributePublicFacts;
}

export function sourceCanBeMonitored(source: SourceAiReviewSource | null | undefined) {
  return explainSourceAiReviewStatus(source).canBeMonitored;
}

export function explainSourceAiReviewStatus(
  source: SourceAiReviewSource | null | undefined,
): SourceAiReviewExplanation {
  const metadata = objectValue(source?.page_metadata);
  ...
  const result = (
    status: SourceAiReviewStatus,
    reason: string,
    overrides: Partial<SourceAiReviewExplanation> = {},
  ): SourceAiReviewExplanation => {
...
function baselineFactsRejected(metadata: Record<string, unknown>) {
  return Boolean(
...
function reviewFailureStatus(metadata: Record<string, unknown>) {
...
function statusForRejectedSignal(signal: string): SourceAiReviewStatus {
